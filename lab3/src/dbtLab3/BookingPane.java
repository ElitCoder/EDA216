...
public class BookingPane extends BasicPane {
     ...
     * list.
     */
    private void fillDateList(String name) {
    ...
    class DateSelectionListener implements ListSelectionListener {
        ...
        public void valueChanged(ListSelectionEvent e) {
            ...
            ArrayList<String> information = db.getMovieInformation(movieName, date);
            
            fields[MOVIE_NAME].setText(information.get(0));
            fields[PERF_DATE].setText(information.get(1));
            fields[THEATER_NAME].setText(information.get(2));
            fields[FREE_SEATS].setText(information.get(3));
